...
但是笔者确实强烈建议所有想要成为AO3用户的人至少理解并赞同AO3的定义：一个非营利、非商业性的同人作品档案馆；由书籍、音乐、艺术、游戏、电视节目、电影、真人同人小说 (RPF) 和其他同人圈的粉丝创建，也为粉丝服务。不过考虑到不过不过虽然不注册账号也一样可以无障碍阅读AO3上的公开作品，但请让我耽误您几分钟，我想为您介绍一下我们的救星，我们神圣的AO3账号……
...
{% hint style="danger" %}
<mark style="color:red;">**注意：以下操作全程需挂梯子使用原网址。**</mark>
{% endhint %}

注册AO3账号的唯一方式就是获得网站的**Invitation（邀请）**。获得邀请的途径有两种：让一名已经注册账号的AO3用户给你发送邀请码，或者去网站首页排队。前者，被邀请即可立刻创建账户，无需等待；后者往往需要等待几天甚至数周（这是正常的！AO3每时每刻都有很多新用户想要注册）。

大部分用户均为排队注册，故优先讲解此方法。
...
2. 在输入框内填写邮箱（出于安全考虑，建议使用不会绑定个人身份的邮箱如Outlook或Gmail；此外，某些国内的邮箱可能无法稳定地接收AO3官方邮箱的邮件）并点击`Add me to the list`按钮。下面那行小字中，红线示意的部分指的是在你之前的排队人数。AO3将以6000条/12小时的速度发放邀请。

<figure><img src=".gitbook/assets/createaccount_fillemail.png" alt=""><figcaption></figcaption></figure>
...
[^1]: 鉴于AO3是一个用户群体鱼龙混杂、内容广泛且多样化的网站，在拥有基本的判断能力后再接触它确实是更好的选择！

[^2]: 但是笔者确实强烈建议所有想要成为AO3用户的人至少理解并认同AO3的定义：一个非营利、非商业性的同人作品档案馆；由书籍、音乐、艺术、游戏、电视节目、电影、真人同人小说 (RPF) 和其他同人圈的粉丝创建，也为粉丝服务。
